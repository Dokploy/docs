---
title: "Web 域名设置"
description: "学习如何为 Dokploy 面板设置主域"
---

## 介绍

本指南涵盖 Dokploy 面板主域的基本设置。
...
![cloudflare 面板](../../../../assets/images/web-domain-setup/domain-setup.png)
...
![域名dokpoly配置](../../../../assets/images/web-domain-setup/dokploy-domain.png)
